...
var simil_trolley = function(color){
	...
	s.push(T([0,2])([3.1,2.7])(R([0,2])([PI/2])(COLOR(color)(c81))));
	var c82 = herm_sup([c8up,c8down,[0,0,tube_depth],[0,0,-tube_depth]]); 
	s.push(T([0,2])([3.1,2.7])(R([0,2])([PI/2])(COLOR(color)(c82))));
	...
	s.push(T([0,2])([3.1,2.7])(R([0,2])([PI/2])(COLOR(color)(c91))));
	var c92 = herm_sup([c9up,c9down,[0,0,tube_depth],[0,0,-tube_depth]]); 
	s.push(T([0,2])([3.1,2.7])(R([0,2])([PI/2])(COLOR(color)(c92))));
	...
	s.push(T([0,2])([3.1,2.7])(R([0,2])([PI/2])(COLOR(color)(d11))));
